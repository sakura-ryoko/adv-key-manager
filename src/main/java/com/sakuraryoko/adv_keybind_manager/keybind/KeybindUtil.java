...
import com.sakuraryoko.adv_keybind_manager.AdvKeybindManager;
...
//#endif
    ...
    @Nullable
    protected static KeyBindingWrapper getById(final String id)
	{
	...
	@Nullable
    protected static KeyBindingWrapper getByCode(final InputUtil.KeyCode keyCode)
	{
    ...
    protected static boolean updateByID(final String id, InputUtil.KeyCode newKeyCode)
    {
        ...
        {
            AdvKeybindManager.LOGGER.error("updateByID: Exception while updating keybind '{}'; {}", id, err.getLocalizedMessage());
            return false;
        }
    }
    ...
    protected static boolean updateByCode(final InputUtil.KeyCode oldKeyCode, InputUtil.KeyCode newKeyCode)
    {
        ...
        {
            AdvKeybindManager.LOGGER.error("updateByCode: Exception while updating keybind '{}'; {}", oldKeyCode.getName(), err.getLocalizedMessage());
            return false;
        }
    }
    ...
    protected static boolean resetByID(final String id)
    {
        ...
        {
            AdvKeybindManager.LOGGER.error("resetByID: Exception while resetting keybind '{}'; {}", id, err.getLocalizedMessage());
            return false;
        }
    }
    ...
    protected static boolean resetByCode(InputUtil.KeyCode oldKeyCode)
    {
        ...
        {
            AdvKeybindManager.LOGGER.error("resetByCode: Exception while updating keybind '{}'; {}", oldKeyCode.getName(), err.getLocalizedMessage());
            return false;
        }
    }
}
