...
import com.sakuraryoko.adv_key_manager.AdvKeyManager;
...
//#if MC >= 12100
        ...
        //$$ else
        //$$ {
            //$$ AdvKeyManager.LOGGER.error("loadFromFile(): Failed to load config file '{}'.", configFile.toAbsolutePath());
        //$$ }
//#else
        ...
        {
            AdvKeyManager.LOGGER.error("loadFromFile(): Failed to load config file '{}'.", configFile.getAbsolutePath());
        }
//#endif
...
//#if MC >= 12100
        ...
        //$$ else
        //$$ {
            //$$ AdvKeyManager.LOGGER.error("saveToFile(): Config Folder '{}' does not exist!", dir.toAbsolutePath());
        //$$ }
//#else
        ...
        {
            AdvKeyManager.LOGGER.error("saveToFile(): Config Folder '{}' does not exist!", dir.getAbsolutePath());
        }
//#endif
    }
