...
//#endif
    ...
    protected static boolean updateByID(final String id, InputUtil.KeyCode newKeyCode)
    {
        ...
        {
            AdvKeyManager.LOGGER.error("updateByID: Exception while updating keybind '{}'; {}", id, err.getLocalizedMessage());
            return false;
        }
    }
    ...
    protected static boolean updateByCode(final InputUtil.KeyCode oldKeyCode, InputUtil.KeyCode newKeyCode)
    {
        ...
        {
            AdvKeyManager.LOGGER.error("updateByCode: Exception while updating keybind '{}'; {}", oldKeyCode.getName(), err.getLocalizedMessage());
            return false;
        }
    }
    ...
    protected static boolean resetByID(final String id)
    {
        ...
        {
            AdvKeyManager.LOGGER.error("resetByID: Exception while resetting keybind '{}'; {}", id, err.getLocalizedMessage());
            return false;
        }
    }
    ...
    protected static boolean resetByCode(InputUtil.KeyCode oldKeyCode)
    {
        ...
        {
            AdvKeyManager.LOGGER.error("resetByCode: Exception while updating keybind '{}'; {}", oldKeyCode.getName(), err.getLocalizedMessage());
            return false;
        }
    }
